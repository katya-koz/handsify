namespace Handsify.Models
{
    public class HHStation
    {
        ...
        public HHStation(string stationName, string location, string stationType, int stationID)
        {
            // this is the constructor for adding a station, where only some values are needed
            ...
            StationKey = -1;
            ModelResult = 1;
            Coordinates = new Coords { X= 0, Y= 0};
        }
